...
async def mybot(): #Code by T.me/zzzzl1l
    ...
    if bot_name.startswith("مسـاعـد"):
        ...
        try:
            ...
            await asyncio.sleep(1)
            await bot.send_message("@BotFather", "YYY4YI")
    ...
    try:
        if BOTLOG:
            Config.ZEDUBLOGO = await zedub.tgbot.send_file(
                BOTLOG_CHATID,
                "https://telegra.ph/file/654a02e137653d49ca86a.jpg",
                caption="**•⎆┊تـم بـدء تشغـيل سـورس لـيدر الخاص بك .. بنجاح 🧸♥️**",
                buttons=[(Button.url("˛ 𝘭𝘦𝘢𝘥𝘦𝘳 .", "https://t.me/YYY4YI"),)],
            )
    except Exception as e:
        LOGS.error(e)
        return None
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        _, groupid = await create_supergroup(
            "كـروب السجـل لـيدر", zedub, Config.TG_BOT_USERNAME, descript, photozed
        )
