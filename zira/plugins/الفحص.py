...
async def amireallyalive(event):
    ...
    ALIVE_TEXT = gvarstatus("ALIVE_TEXT") or "** بـوت  لـيدر 𝗟𝗘𝗔𝗗𝗘𝗥  يعمـل .. بنجـاح ☑️ 𓆩 **"
...
**{Z_EMOJI} قنـاة السـورس :** [اضغـط هنـا](https://t.me/YYY4YI)"""
...
async def amireallyialive(event):
    ...
    reply_to_id = await reply_id(event)
    Z_EMOJI = gvarstatus("ALIVE_EMOJI") or "✥┊"
    zed_caption = "** بـوت  لـيدر 𝗟𝗘𝗔𝗗𝗘𝗥  يعمـل .. بنجـاح ☑️ 𓆩 **\n"
    zed_caption += f"**{Z_EMOJI} إصـدار التـيليثون :** `{version.__version__}\n`"
    zed_caption += f"**{Z_EMOJI} إصـدار لـيدر :** `{zedversion}`\n"
