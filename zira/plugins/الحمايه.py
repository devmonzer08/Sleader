...
async def do_pm_permit_action(event, chat):  # sourcery no-metrics
    ...
    if custompmpermit is not None:
        ...
        USER_BOT_NO_WARN = f"""ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗟𝗘𝗔𝗗𝗘𝗥 **- الـرد التلقـائي 〽️**
**•─────────────────•**
...
async def on_new_private_message(event):
    ...
    zel_dev = (6638991453, 6638991453, 6650021309, 6076387551)
    ...
    if event.chat_id == 6638991453 or event.chat_id == 6650021309 or event.chat_id == 5449190469 or event.chat_id == 6076387551:
